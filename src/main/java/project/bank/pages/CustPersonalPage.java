...
public class CustPersonalPage {
	...
	public void custPage(int id) {
		System.out.println("\n=============================================================");
		System.out.println("Personal page for " + customerDAO.getCustomerfn(id) + " " + customerDAO.getCustomerln(id));
		approvalStatus(id);
		...
		if (customerDAO.custStatus(id1)) {
			...
			if (askTransfer == true) {
				...
				if (id2 < 0) {
					...
					tAmount = -1;
					askTransfer = false;
				} else if (customerDAO.doesCustExist(id2) && customerDAO.custStatus(id2)) {
					System.out.println("Are you sure you would like to transfer $" + tAmount + " to user " + "with id: "
							+ id2 + "?");
					...
					System.out.println("ERROR: User with id: " + id2 + " is not verified or "
			...
			System.out.println("ERROR: You can not send money until your account has been approved.\n"
					+ "An Associate will approve of your account in a timely manner.");
			tAmount = 1;
		}
	}
}
